...
calculate.onclick = () => {
  result.innerHTML = `<h5 class="alert alert-dark mt-5 text-center">Your Exchange Amount is = ${(
    (amount.value / from.value) *
    to.value
  ).toFixed(2)} ${currency}</h5>`;
